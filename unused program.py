...
class Player:
    def __init__(self):
        ...
        self.dictenary_napr = {"down": [0, "y", 50], "right": [90, "x", 50], "up": [180, "y", -50], "left": [270, "x", -50]}
...
class Bullet:
    def __init__(self, x, y, board, napravlenie):
        ...
        self.num_sprite = [0, 0]
        self.list_sprites = [pygame.image.load("textures/bullet_1.png"), pygame.image.load("textures/bullet_2.png"),
                             pygame.image.load("textures/bullet_3.png")]
